...
import com.aminbadh.tdrmanagerslpm.databinding.ActivityLoginBinding;
...
import static com.aminbadh.tdrmanagerslpm.custom.Constants.ROLE_DEV;
import static com.aminbadh.tdrmanagerslpm.custom.Constants.ROLE_FIELD;
import static com.aminbadh.tdrmanagerslpm.custom.Constants.ROLE_MANAGER;
        ...
        db.collection(USERS_COLLECTION).document(id).get()
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (role != null && (role.equals(ROLE_MANAGER) || role.equals(ROLE_DEV))) {
                            // Start the MainActivity.
                            startMainActivity();
                        } else {
                            // Enable the buttons.
